...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
figure('units','normalized','outerposition',[0 0 1.0 0.46])
ax1=subplot(1,3,1);
...
set(colorTitleHandle ,'String',titleString,'FontSize',font_sz);
set(gca,'FontSize',font_sz,'fontWeight','bold');
name='/Users/pavelplotnitskii/Library/CloudStorage/Dropbox/Apps/Overleaf/seg_23_alkhobar_workshop/Fig/snapshot_it_1200.png'; delete(name); print(name,'-dpng',['-r' num2str(400)]);
ss=1;
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
