...
fname=['/Volumes/ssd1/SIMWAVE/simwave/seismic/sismos_101.raw'];
dims=[2601,200];    dims2=[51,51,200];
...
fclose(fileID);
data = reshape(A,dims);
data3d=reshape(A,dims2);

% plotting
figure
% imagesc( squeeze(data(:,:,11)).' );
imagesc(data(120:180,:)')
% imagesc(data(:,:)')
val=1e-15;
clim([-val,val])
colorbar
