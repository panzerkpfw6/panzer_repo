...
num_threads_min=$(expr $num_threads_max / 1)
num_threads_step=$(expr $num_threads_max /1)
num_threads=($(seq $num_threads_min $num_threads_step $num_threads_max))

tgs_values_min=4
tgs_values_step=2
tgs_values_max=6     #controlled in the loop for tgs<num_threads
tgs_values=($(seq $tgs_values_min $tgs_values_step $tgs_values_max))

#size_values=(512 1024 2048)
size_values=(512 1024)
timesteps=2000 ###???
num_wf=21
t_dim=3
mode=2
