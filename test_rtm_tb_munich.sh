...
srun --ntasks=1 --cpus-per-task=$OMP_NUM_THREADS --hint=nomultithread --unbuffered numactl --interleave=all ./bin/rtm --verbose --n1 $size1  --n2 $size1 --n3 $size2 --iter $timesteps --dshot 1 --first 1301 --last 1301 --nb_snap $nb_snap
#####*********** SB tests ************###
echo !!TB default!!
