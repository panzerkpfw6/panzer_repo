...
make clean;make VERBOSE=1;make install
ss=1
...
#numactl --interleave=all ./bin/modeling  --verbose --n1 512 --n2 512 --n3 512 --iter 500 --dshot 1 --first 1301 --last 1301 > SB.log
numactl --interleave=all ./bin/modeling  --verbose --n1 512 --n2 512 --n3 512 --iter 104 --dshot 1 --first 1301 --last 1301
mv SB_lastshot_u0 data/SB-final_snap.raw

numactl --interleave=all ./bin/modeling  --verbose --n1 512 --n2 512 --n3 512  --iter 104  --tb_thread_group_size 4 --tb_nb_thread_groups 9 --tb_th_x 1 --tb_th_y 2 --tb_th_z 2 --tb_t_dim 3 --tb_num_wf 21 --dshot 1 --first 1301 --last 1301 -c
