...
#numactl --interleave=all ./bin/modeling  --verbose --n1 256 --n2 256 --n3 256  --iter 505  --tb_thread_group_size 4 --tb_nb_thread_groups 14 --tb_th_x 2 --tb_th_y 2 --tb_th_z 1 --tb_t_dim 7 --tb_num_wf 21 --dshot 1 --first 1301 --last 1301 -c
